...
{
	m_allowSound = true;
	m_Path = "C:/Documents/code/RockItMan.cpp/Sources/Data/";
...
void ResourceManager::changeTrap()
{
	skinTrap++;
	if (skinTrap >= 9) skinTrap = 1;
}

void ResourceManager::changeCloud()
{
	skinCloud++;
	if (skinCloud >= 9) skinCloud = 1;
}
